package com.example.resourcegenerator.permission;
...
public class PermissionManager {
    ...
    // Permission nodes
    public static final String PERMISSION_CREATE = "resourcegenerator.create";
    public static final String PERMISSION_USE = "resourcegenerator.use";
    public static final String PERMISSION_ADMIN = "resourcegenerator.admin";
    public static final String PERMISSION_RELOAD = "resourcegenerator.reload";
    public static final String PERMISSION_GIVE = "resourcegenerator.give";
    public static final String PERMISSION_BYPASS_LIMITS = "resourcegenerator.bypass.limits";
    public static final String PERMISSION_ACCESS_ALL = "resourcegenerator.access.all";

    public PermissionManager(ResourceGeneratorPlugin plugin) {
        this.plugin = plugin;
