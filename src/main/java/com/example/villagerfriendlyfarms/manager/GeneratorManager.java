package com.example.villagerfriendlyfarms.manager;
...
import com.example.villagerfriendlyfarms.storage.DataStorage;
...
public class GeneratorManager {
    ...
    public GeneratorManager(VillagerFriendlyFarmsPlugin plugin) {
        this.plugin = plugin;
