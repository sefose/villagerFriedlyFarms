package com.example.villagerfriendlyfarms;

import com.example.villagerfriendlyfarms.config.ConfigManager;
import com.example.villagerfriendlyfarms.listener.BlockEventListener;
import com.example.villagerfriendlyfarms.listener.CraftingEventListener;
import com.example.villagerfriendlyfarms.listener.PlayerInteractionListener;
...
import com.example.villagerfriendlyfarms.recipe.RecipeManager;
import org.bukkit.plugin.java.JavaPlugin;

/**
 * Main plugin class for the Villager Friendly Farms plugin.
 * 
 * This plugin allows players to craft villager-friendly farming devices using specific recipes.
 * Farms appear as custom blocks and accumulate resources over time using a passive
 * calculation system.
 */
public class VillagerFriendlyFarmsPlugin extends JavaPlugin {

    private static VillagerFriendlyFarmsPlugin instance;
    ...
    public void onEnable() {
        ...
        try {
            getLogger().info("VillagerFriendlyFarms plugin starting up...");
            ...
            getCommand("vff").setExecutor(new com.example.villagerfriendlyfarms.command.GeneratorCommand(this));
            ...
            getLogger().info("VillagerFriendlyFarms plugin fully initialized!");
    ...
    public void onDisable() {
        try {
            getLogger().info("VillagerFriendlyFarms plugin shutting down...");
            ...
            getLogger().info("VillagerFriendlyFarms plugin has been disabled!");
     ...
     */
    public static VillagerFriendlyFarmsPlugin getInstance() {
        return instance;
    }
